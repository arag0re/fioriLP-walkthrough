		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "walkthrough",
									"targetURL": "#deicontecantonstadiewalkthrough-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"deicontecantonstadiewalkthrough-display": {
								"semanticObject": "deicontecantonstadiewalkthrough",
								"action": "display",
								"description": "a simple tutorial app to get used to the SAPUI5 framework",
								"title": "walkthrough",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=de.icontec.antonstadie.walkthrough",
									"url": sap.ui.require.toUrl("de/icontec/antonstadie/walkthrough")
								}
							}
						}
					}
